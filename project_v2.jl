...
function network(config)
    ...
    PV = Population(inh_PV; synapse, spike, N=Npop.CortPvInh, name="CortPvInh")         # Inhibitory population
    SST = Population(inh_SST; synapse, spike, N=Npop.CortSstInh, name="CortSstInh")     # Inhibitory population
    VIP = Population(inh_VIP; synapse, spike, N=Npop.CortVipInh, name="CortVipInh")     # Inhibitory population
